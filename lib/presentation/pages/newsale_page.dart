...
import 'package:mobile_app_slb/presentation/pages/assemblycreated_page.dart';
            ...
            child: Column(
              ...
              children: [
                            ...
                            if (ref.watch(cartDataProvider).transactionId !=
                              ...
                              showDialog(
                                  ...
                                  builder: (context) {
                                    ...
                                    return AlertDialog(
                                      title: Text(
                                          AppLocalizations.of(context)!.areYouWantAssembling),
                                      actions: [
                                        TextButton(
                                            onPressed: () {
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      (data[index].curPrice.toStringAsFixed(2))
                                          .toString(),
                                      style: const TextStyle(
                                          fontSize: 16,
                                          color: Color(0xFF3A3A3A)),
                ...
                Padding(
                  ...
                  child: Text(
                    "${AppLocalizations.of(context)!.total} ${sum.toStringAsFixed(2).toString()}",
                    style: const TextStyle(
